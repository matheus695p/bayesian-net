...
Modelo intrínsecamente interpretable: una solución para interpretar modelos de caja negra es aproximarlos (ya sea global o localmente) con un modelo interpretable. El modelo interpretable en sí se interpreta observando los parámetros internos del modelo o las estadísticas de resumen de características.
